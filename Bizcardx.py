...
with tab1:
  ...
  st.subheader("About:")
  st.write("Welcome to BizCard Extractor, a powerful tool designed to simplify the process of extracting and managing data from business cards.")
  st.write("This project leverages cutting-edge technologies to provide an efficient and user-friendly experience for individuals and businesses alike.")

  st.subheader("Key Features:")
  st.write("**Upload and Extract:** Easily upload business card images and extract textual information using advanced OCR technology.")
  st.write("**Data Management:** Save extracted data to a database, preview and modify the information, and delete entries as needed.")
  st.write("**Multiple Formats:** Supports various image formats, including PNG, JPG, and JPEG.")

  st.subheader("How it works:")
  st.write("**Image Upload:** Users can upload images of their business cards.")
  st.write("**Text Extraction:** The app uses EasyOCR to extract text from the uploaded images.")
  st.write("**Data Display:** Extracted data is organized into relevant fields and displayed in a tabular format.")
  st.write("**Data Management:** Users can save, preview, modify, and delete extracted data using intuitive controls.")

  st.subheader("Technologies Used:")
  st.write("**Streamlit:** For creating an interactive and dynamic web app.")
  st.write("**EasyOCR:** For robust optical character recognition.")
  st.write("**PIL:** For image processing.")
  st.write("**SQLite:** For storing and managing extracted data.")
...
#creating dictionary
      ...
      if button_1:
        ...
        check_query = '''SELECT * FROM  Bizcard_Details WHERE EMAIL = ?'''
        cursor.execute(check_query,(datas[4],))
        result = cursor.fetchone()

        if result:
          st.warning("This Business Already Exists")
        else:

        # insert query

          insert_query = ''' INSERT OR IGNORE INTO Bizcard_Details (NAME,DESIGNATION,COMPANY_NAME,CONTACT,EMAIL,WEBSITE,ADDRESS,
                                                        PINCODE,IMAGE)
